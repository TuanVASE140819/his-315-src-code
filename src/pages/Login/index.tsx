...
function Login() {
  ...
  const renderLi = (text) => {
    return (
      <li className='flex items-center bg-pink-900 bg-opacity-50 rounded-full p-3 transition-all hover:bg-opacity-70'>
  ...
  return (
    !token && (
      <>
        ...
        >
          <div className='bg-gradient-to-r from-pink-400 via-pink-500 to-rose-400 min-h-screen flex items-center justify-center p-4'>
            <div className='w-full max-w-6xl flex flex-col md:flex-row bg-white bg-opacity-10 rounded-3xl shadow-2xl overflow-hidden items-center'>
              ...
              >
                ...
                >
                  {renderLi('Hệ thống quản lý bệnh viện')}
                </motion.ul>
              </motion.div>
              <motion.div
