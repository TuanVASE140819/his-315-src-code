          ...
          {(item) => (
            <List.Item key={item?.id}>
                ...
                title={
                  <>
                    <div className='flex justify-start items-center gap-3'>
                      <div
                        className='text-gray-700 hover:text-[#E97195] cursor-pointer'
              ...
              <div className='flex justify-end items-center gap-5'>
                ...
                <EyeOutlined
                  className='text-xl text-[#E97195] hover:text-[#C3215F] transition-all duration-300 cursor-pointer'
                  onClick={() => onClickItem(item)}
                />
              </div>
            </List.Item>
            ...
            >
              ...
              >
                <List.Item.Meta
                  ...
                  title={
                    <div className='text-gray-700 hover:text-[#E97195] cursor-pointer'>
                      {'Nguyễn Hoàng Tiến'}
