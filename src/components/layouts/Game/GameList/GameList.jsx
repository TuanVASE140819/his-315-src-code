...
import { Avatar, Checkbox, Popconfirm, Empty, Button, Tag } from 'antd'
import {
  EditOutlined,
  FileImageOutlined,
  CrownOutlined,
  ...
  return (
    <ul className='flex flex-col gap-4 mt-2 border rounded-md p-4 h-[79.5vh] overflow-auto bg-[#fdfdfd]'>
      ...
      {list?.map((item, index) => (
        <li
          key={index}
          className={`bg-white hover:bg-slate-50 transition-all duration-300 border shadow-md rounded-md p-3`}
        >
