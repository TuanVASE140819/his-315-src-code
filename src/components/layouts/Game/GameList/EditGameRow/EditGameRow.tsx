        ...
        <div className='flex flex-col gap-3'>
          <div className='w-full grid grid-cols-3 items-center'>
            ...
            <div className='pl-1.5 flex justify-start items-center gap-2'>
              ...
              />
              <SaveOutlined
                className='ml-auto text-lg text-[#E97195] hover:text-[#C3215F] transition-all duration-300 cursor-pointer'
          ...
          <ul className='w-full flex flex-wrap justify-start gap-3'>
            ...
            <li
              key={'add'}
              className={`min-[1900px]:w-[32.65%] w-[32.3%] h-[58.0625px] border border-dashed ${!infoEdit?.gameItems?.length ? 'border-red-500 text-red-500 bg-red-50 bg-opacity-30' : ''} hover:border-[#E97195] text-gray-600 hover:text-[#E97195] hover:bg-pink-50 rounded-md p-2 bg-[#fff] flex justify-center items-center gap-2 cursor-pointer`}
